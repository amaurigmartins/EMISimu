...
app.CBTowerC1.Value = 7;

% Capacitor bank impedances:
% If Delta Connection (AB)
app.CBImpedanceR1C1.Value = 1e-3; %R1 [ohm]
app.CBImpedanceL1C1.Value = 100e-3; %L1 [mH]
app.CBImpedanceC1C1.Value = 0.25; %C1 [uF]

% If Delta Connection (BC)
app.CBImpedanceR2C1.Value = 1e-3; %R2 [ohm]
app.CBImpedanceL2C1.Value = 100e-3; %L2 [mH]
app.CBImpedanceC2C1.Value = 0.25; %C2 [uF]

% If Delta Connection (CA)
app.CBImpedanceR3C1.Value = 1e-3; %R3 [ohm]
app.CBImpedanceL3C1.Value = 100e-3; %L3 [mH]
app.CBImpedanceC3C1.Value = 0.25; %C3 [uF]

% Grounding impedance
app.CBGroundImpedanceRC1.Value = 0; %R1 [ohm]
app.CBGroundImpedanceLC1.Value = 0; %L1 [mH]
app.CBGroundImpedanceCC1.Value = 0.25; %C1 [uF]
