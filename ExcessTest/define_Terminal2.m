...
app.LoadR1C1T2.Value = 752.41; %R1 [ohm]
app.LoadL1C1T2.Value = 656; %L1 [mH]
app.LoadC1C1T2.Value = 0; %C1 [uF]

% If Delta Connection (BC)
app.LoadR2C1T2.Value = 752.41; %R2 [ohm]
app.LoadL2C1T2.Value = 656; %L2 [mH]
app.LoadC2C1T2.Value = 0; %C2 [uF]

% If Delta Connection (CA)
app.LoadR3C1T2.Value = 752.41; %R3 [ohm]
app.LoadL3C1T2.Value = 656; %L3 [mH]
...
app.R0S1T2.Value = 0; %R0 [ohm/m]
app.L0S1T2.Value = 30.387; %L0 [mH/m]
app.R1S1T2.Value = 0; %R+ [ohm/m]
app.L1S1T2.Value = 10.409; %L+ [mH/m]
...
%% TERMINAL 2 OUT EMI ZONE

app.Source.OutEMIZoneLengthT2.Value = 100; % Distance [m] (if distance = 0, doesn't exist out EMI zone)
