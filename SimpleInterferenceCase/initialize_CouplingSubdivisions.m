...
spanLength = getSpanLength(app);

[ResultTable, LCC_matrix] = sub_code(srcCoord,tgtCoord,spanLength);

app.TableEquivalentDistance.Data = LCC_matrix(:,1);
app.TableEquivalentLength.Data = LCC_matrix(:,2);
app.TableAccTargetDistance.Data = LCC_matrix(:,3);
app.TableSourceGroundingIndex.Data = LCC_matrix(:,4);
app.TableTargetSpanLength.Data = ResultTable(:,7);
app.TableSourceSpanLength.Data = ResultTable(:,8);
app.TableSubTargetCoordinates.Data = ResultTable(:,3:4);
app.TableSubSourceCoordinates.Data = ResultTable(:,1:2);

app.Numberofsections.Value = size(LCC_matrix,1);





function [ResultTable, LCC_matrix] = sub_code(src,tgt,span_length)
%% DESCRIÇÃO:
