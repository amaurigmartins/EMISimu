...
app.Tow2Ground(1).From.Value = 4;
app.Tow2Ground(1).To.Value = 4;
...
app.ShieldCurr(1).From.Value = 3;
app.ShieldCurr(1).To.Value = 4;
app.ShieldCurr(2).From.Value = 4;
app.ShieldCurr(2).To.Value = 5;
