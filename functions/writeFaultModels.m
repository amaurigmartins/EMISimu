...
out=strcat(out,'DATA\n');
out=strcat(out,strcat('  anginc:= ',modprin(app,8,anginc),'\n'));
out=strcat(out,strcat('  tipo:= ',modprin(app,8,ftype),'\n'));
out=strcat(out,strcat('  f:= ',modprin(app,8,freq),'\n'));
out=strcat(out,strcat('  npre:= ',modprin(app,8,npre),'\n'));
out=strcat(out,'OUTPUT\n');
