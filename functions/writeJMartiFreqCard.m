...
out1(1:8)=modprin(8,rho);
out1(9:18)=modprin(10,fmat);
out1(45:52)=modprin(8,L);
out1(70:72)='1-9';

out2(1:8)=modprin(8,rho);
out2(9:18)=modprin(10,fss);
out2(45:52)=modprin(8,L);
out2(70:72)='1-9';

%         1         2         3         4         5         6         7         8
%12345678901234567890123456789012345678901234567890123456789012345678901234567890
%    100.       60.                                1.         6 10    1-9
out3(1:8)=modprin(8,rho);
out3(9:18)=modprin(10,f);
out3(45:52)=modprin(8,L);
