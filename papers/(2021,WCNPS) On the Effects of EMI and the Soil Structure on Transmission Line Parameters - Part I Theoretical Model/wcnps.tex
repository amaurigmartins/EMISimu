...
\author{\IEEEauthorblockN{Caio M. Moraes \orcid{0000-0002-3839-2789}\IEEEauthorrefmark{1}, \textit{Student Member}, \textit{IEEE}, Amauri G. Martins-Britto \orcid{0000-0002-2691-9061} \IEEEauthorrefmark{2}, \textit{Member}, \textit{IEEE},\\ Felipe V. Lopes \orcid{0000-0001-6465-8045}\IEEEauthorrefmark{3}, \textit{Senior Member}, \textit{IEEE},
		Kleber M. Silva \orcid{0000-0003-0847-4545}\IEEEauthorrefmark{4}, \textit{Senior Member}, \textit{IEEE}}
	\IEEEauthorblockA{Departament of Electrical Engineering, University of Brasília, Brasília, Brazil\IEEEauthorrefmark{1}\IEEEauthorrefmark{2}\IEEEauthorrefmark{4}
		\\
		Departament of Electrical Engineering, Federal University of Paraíba, João Pessoa, Brazil\IEEEauthorrefmark{3}
		\\
		Email:  caio.missiaggia@aluno.unb.br\IEEEauthorrefmark{1}}
...
\begin{abstract}
		...
		This paper presents a methodology for computing the electrical parameters of overhead transmission lines accounting for metallic pipeline interferences and soil stratification effects. The method is based on the closed-form analytical solution of the Carson's integral, which is used to calculate self and mutual line parameters. A wide variety of scenarios on a 230 kV/60 Hz transmission line 200 km long, considering a hypothetical case of interferences with a pipeline and soil stratifications based on resistivity measurements. Obtained results reveal that zero sequence impedance may be significantly affected by uncertainties due to pipeline interferences and soil layered structure, thereby a more robust line parameter calculation in practical applications is required to avoid errors in line design which uses zero sequence as fundamental parameters.
